...
## Project Structure
    ...
    ├── cooking_together_de_84416  # Django project configurations
...
1. Clone this repo and `cd cooking_together_de_84416`
...
2. Clone this repo and `cd cooking_together_de_84416`
